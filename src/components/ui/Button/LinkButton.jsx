...
function LinkButton({ text, onClick, href, target }) {
  return (
    <>
      <a href={href} onClick={onClick} target={target} className="relative inline-flex items-center justify-center px-5 py-[5px] overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group cursor-pointer text-sm md:text-base">
