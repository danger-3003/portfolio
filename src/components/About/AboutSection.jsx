...
function AboutSection() {
  return (
    <>
      <div className='w-full overflow-hidden flex items-center justify-center flex-col pt-20 pb-24 px-5 md:px-10'>
        <div className='max-w-[80rem] w-full '>
          <div className='w-full flex items-center justify-center flex-col-reverse md:flex-row gap-10 lg:gap-32'>
            <div className='sm:basis-[60%] lg:basis-2/3 flex items-start justify-start flex-col gap-7 lg:gap-10'>
              <Heading data-aos="fade-right" className="uppercase text-4xl lg:text-5xl">Who I Am?</Heading>
              <Text data-aos="fade-right" data-aos-delay="100" className="text-justify">
          ...
          <div className='border-l-2 pl-1.5 py-5 mt-10 border-black dark:border-white text-primary-400 flex items-start justify-start flex-col gap-2 w-full sm:w-[65%] lg:w-2/3 custom-transition overflow-hidden'>
            <div className='flex items-start justify-start flex-row text-3xl'>
              <span data-aos="fade-right" data-aos-delay="200" className='text-[3.5rem] md:text-[4.5rem] font-poppins pr-1.5'>❝</span><p className='w-auto' data-aos="fade-right" data-aos-delay="200">Design is not just what it looks like and feels like. Design is how it works.<span className='text-xl font-poppins' data-aos="fade-right" data-aos-delay="200">❞</span></p>
            </div>
            <div className='pl-8'>
