  ...
  return (
    <>
      ...
      <div className='bg-slate-100 dark:bg-zinc-800/40 h-[6.5rem] sm:h-16 flex items-start sm:items-center justify-center py-3 border-t border-text w-full'>
        <Text className="text-text">Designed by <span className='bg-gradient-to-r from-blue-500 to-blue-500 text-transparent bg-clip-text font-bold'>Hima Varsha</span> with ❤️</Text>
      </div>
    </>
  )
}
